      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="product">
              <a href="#" class="img-prod">
                <img class="img-fluid" src={product1} alt="Colorlib Template" />
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="product">
              <a href="#" class="img-prod">
                <img class="img-fluid" src={product2} alt="Colorlib Template" />
                <div class="overlay"></div>
              </a>
              <div class="text py-3 px-3">
                <h3>
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="product">
              <a href="#" class="img-prod">
                <img class="img-fluid" src={product3} alt="Colorlib Template" />
                <div class="overlay"></div>
              </a>
              <div class="text py-3 px-3">
                <h3>
          ...
          <div class="col-sm col-md-6 col-lg ftco-animate">
            <div class="product">
              <a href="#" class="img-prod">
                <img class="img-fluid" src={product4} alt="Colorlib Template" />
                <div class="overlay"></div>
              </a>
              <div class="text py-3 px-3">
                <h3>
